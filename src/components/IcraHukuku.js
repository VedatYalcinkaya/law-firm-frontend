        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center my-12 md:my-24">
          <div className="flex flex-col w-full lg:w-2/3 justify-center items-start p-8">
            ...
            <p className="text-sm md:text-base text-fifth mb-4">
              Demirci Hukuk Bürosu olarak icra hukuku alanında borçlu ve alacaklıların haklarını koruma amacıyla profesyonel hizmet sunuyoruz. Haciz, tahsilat ve alacak takibi gibi konularda müvekkillerimize en etkili ve hızlı çözümleri sunmayı hedefliyoruz.
              <br /><br />
              İcra hukuku, borçluların borçlarını ödememesi durumunda, alacaklıların haklarını koruma amacıyla başvurulan hukuki yolları kapsar. Bu süreçte icra takibi, haciz, rehin ve iflas gibi çeşitli yöntemler kullanılır. Demirci Hukuk Bürosu olarak, müvekkillerimizin alacaklarının tahsil edilmesi noktasında hukuki sürecin her aşamasında yanlarındayız. 
              <br /><br />
              ...
              <br /><br />
              Demirci Hukuk Bürosu olarak, alacaklı müvekkillerimizin haklarını korumak ve en hızlı şekilde sonuç almak adına icra ve haciz işlemlerini titizlikle yürütüyoruz. Borçlular açısından ise hukuki haklarını korumak ve olası mağduriyetleri önlemek amacıyla danışmanlık hizmeti sunmaktayız. 
              <br /><br />
              ...
              <br /><br />
              İcra hukuku karmaşık ve teknik detaylar içeren bir alan olup, hukuki bilgi ve deneyim gerektirir. Demirci Hukuk Bürosu olarak, uzman ekibimizle birlikte müvekkillerimize en uygun ve etkili çözümleri sunarak, haklarını en iyi şekilde savunmayı amaçlıyoruz.
            </p>
          </div>
