        ...
        <section>
            ...
            <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
                ...
                <p className="mb-8 text-sm text-center text-fifth sm:text-base lg:mb-24">
                    Demirci Hukuk Bürosu olarak, müvekkillerimize en üst düzeyde hukuki hizmet sunmayı ve adaletin sağlanmasına katkıda bulunmayı misyon edindik. Müvekkillerimizin ihtiyaçlarını gözeterek çözüm odaklı, etik ve şeffaf bir yaklaşım benimsiyoruz.
                </p>
                <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
                    ...
                    <div className="flex flex-col gap-5 rounded-2xl border border-solid border-black p-10 sm:p-20">
                        ...
                        <p className="text-sm text-fifth sm:text-base">
                            Demirci Hukuk Bürosu olarak, hukuki süreçlerde müvekkillerimize en iyi desteği sunmayı hedefliyoruz. Adil ve etkili çözümler üreterek, toplumda hukukun üstünlüğünü sağlamak ve müvekkillerimizin haklarını korumak için çalışıyoruz. 
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            Demirci Hukuk Bürosu, ticaret hukuku, aile hukuku, ceza hukuku, iş hukuku gibi farklı alanlarda geniş bir yelpazede hukuki hizmetler sunmaktadır. Müvekkillerimize hem bireysel hem de kurumsal olarak en iyi hizmeti vermek adına sürekli kendimizi geliştiriyor ve en güncel yasal düzenlemeleri takip ediyoruz.
                        </p>
                    </div>
                </div>
                <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:gap-12">
                    <div className="flex flex-col gap-5 rounded-2xl border border-solid border-black p-10 sm:p-20">
                        ...
                        <p className="text-sm text-fifth sm:text-base">
                            Demirci Hukuk Bürosu olarak vizyonumuz, müvekkillerimizin haklarını en etkili şekilde savunarak, güvenilir ve saygın bir hukuk bürosu olmaktır. Hukuk sistemine olan inancı artırmak ve toplumsal adaletin sağlanmasına katkıda bulunmak en büyük hedeflerimizden biridir. 
                            <br />
                            <br />
