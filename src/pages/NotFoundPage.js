...
const NotFoundPage = () => {
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-transparent bg-fixed bg-cover bg-bottom"
    //   style={{
    ...
    >
      <div className="text-center text-gray-50">
        <div className="relative">
          <h1 className="text-9xl tracking-tighter-less font-sans font-bold text-shadow">
            <span>4</span>
            <span>0</span>
            <span>4</span>
          </h1>
        ...
        <h5 className="text-gray-300 font-semibold mt-4">Sayfa Bulunamadı</h5>
        <p className="text-gray-100 mt-2 mb-6">
          Üzgünüz, Fakat aradığınız sayfayı bulamadık.
        </p>
        <Link
          to="/"
